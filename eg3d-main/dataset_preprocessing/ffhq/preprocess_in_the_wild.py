...
folder_name = args.indir.split('/')[-1]
...
command = "python 3dface2idr_mat.py --in_root ./Deep3DFaceRecon_pytorch/checkpoints/pretrained/results/"+folder_name+"/epoch_20_000000"
print(command)
os.system(command)
print('3------------------------------------------------------------------------')

# additional correction to match the submission version
command = "python preprocess_cameras.py --source Deep3DFaceRecon_pytorch/checkpoints/pretrained/results/"+folder_name+"/epoch_20_000000 --mode orig"
print(command)
os.system(command)
print('4------------------------------------------------------------------------')
